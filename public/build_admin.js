    ...
    <div id="dashboard" class="w-full flex min-h-screen hidden">
        ...
        <main class="ml-[260px] flex-1 p-margin-desktop min-h-screen bg-background w-full">
            ...
            <div id="tab-doctors" class="tab-content hidden">
                ...
                <div id="doctor-schedule-view" class="hidden">
                    <div class="flex justify-between items-center mb-6">
                        <div class="flex items-center gap-4">
                            <button onclick="closeDoctorSchedule()" class="bg-surface-container border border-outline-variant text-on-surface hover:bg-surface-container-high px-4 py-2 rounded-full font-label-md transition flex items-center gap-2">
                                <span class="material-symbols-outlined">arrow_back</span> Orqaga
                            </button>
                            <h3 id="schedule-doctor-name" class="font-headline-md text-on-surface">Shifokor jadvali</h3>
                        </div>
                    </div>
