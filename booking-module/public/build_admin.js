    ...
    <div id="dashboard" class="w-full flex min-h-screen hidden">
        ...
        <nav id="admin-sidebar" class="fixed left-0 top-0 h-screen flex flex-col py-margin-desktop border-r border-outline-variant bg-surface-container-low w-sidebar-width z-50">
            ...
            <ul class="flex-1 overflow-y-auto px-2 space-y-1">
                <li>
                    <button onclick="switchTab('appointments')" class="w-full text-left nav-item text-on-surface-variant flex items-center gap-3 px-4 py-3 font-label-md hover:bg-surface-container-high transition-all rounded-full active bg-secondary-container text-on-secondary-container">
        ...
        <main class="ml-[260px] flex-1 p-margin-desktop min-h-screen bg-background w-full">
            ...
            <header class="flex justify-between items-center mb-10">
                <div>
                    <h2 class="font-headline-lg text-headline-lg text-on-surface">Admin Panel</h2>
                    <p class="font-body-md text-body-md text-on-surface-variant mt-1">Clinova klinika boshqaruvi</p>
                </div>
            </header>

            <!-- TABS -->
            <div id="tab-appointments" class="tab-content block">
            ...
            <div id="tab-users" class="tab-content hidden">
                ...
                <div class="bg-surface-container-lowest rounded-xl border border-outline-variant/30 shadow-sm overflow-hidden">
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-surface-container-low text-on-surface-variant font-label-md uppercase">
                                <th class="py-3 px-6">Foydalanuvchi</th>
                                <th class="py-3 px-6">Raqam/TG</th>
                                <th class="py-3 px-6">Rol</th>
                                <th class="py-3 px-6">Shifokor birik.</th>
                                <th class="py-3 px-6 text-right">Amallar</th>
                            </tr>
                        </thead>
