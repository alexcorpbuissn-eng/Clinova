            ...
            <header class="flex flex-col lg:flex-row lg:items-end justify-between gap-4 pb-4 border-b border-surface-variant">
                <div>
                    ...
                    <h1 class="font-headline-lg text-on-surface flex items-center gap-4">
                        Ish Grafigi
                        <div id="admin-doc-selector" class="hidden items-center ml-4">
                            <select id="doc-select" onchange="switchDoctor(this.value)" class="py-2 px-4 pr-10 rounded-xl border border-outline-variant bg-surface-container-lowest font-body-md text-on-surface focus:border-primary focus:ring-2 focus:ring-primary/20 appearance-none shadow-sm cursor-pointer hover:border-outline transition-all">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start h-[calc(100vh-140px)]">
                ...
                <section class="xl:col-span-4 flex flex-col gap-6 h-full">
                    ...
                    <div class="bg-surface-container-lowest rounded-xl border border-surface-variant shadow-sm flex flex-col overflow-hidden h-full">
                        <div class="p-5 border-b border-outline-variant/30 flex justify-between items-center bg-surface-container-lowest">
                            <h3 class="font-headline-sm text-primary flex items-center gap-3">
                                <span class="material-symbols-outlined fill-icon text-[24px]">queue</span> Navbat (Bemorlar)
                            </h3>
                            <button onclick="loadDoctorPatients()" class="w-10 h-10 flex items-center justify-center hover:bg-surface-container rounded-full text-on-surface-variant transition-colors" title="Yangilash"><span class="material-symbols-outlined">refresh</span></button>
                        </div>
